...
public class Menu {
    ...
    public void render(Graphics g){
        ...
        if(jogo.estadoJogo == ESTADO.Menu){
            ...
            try {
                this.quitImagem = ImageIO.read(new File(file.getAbsoluteFile()+"\\src\\main\\java\\tacocat\\Sprites\\portaQuit.png"));
        ...
        //Imagens no help
            ...
            g.drawString("2- Para acertar os tacocats do lado direito", 10,130);
        ...
        //Imagens do gameover e limpar a string de objetos
            ...
            try{
                FileInputStream arquivo = new FileInputStream(file.getAbsoluteFile()+"\\src\\main\\java\\tacocat\\Files\\Score.txt");
