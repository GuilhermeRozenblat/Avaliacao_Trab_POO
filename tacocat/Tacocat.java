...
public class Tacocat extends GameObject {
    ...
    public Tacocat(int x, int y, int velx, int vely, int limEsq, int limDir, int width, int height, boolean direita) throws ObjetoNaoEncontradoException, IOException {
        ...
        if(ImageIO.read(new File(file.getAbsoluteFile()+"\\src\\main\\java\\tacocat\\Sprites\\tacocat.png")) == null){
