...
public class Purrito extends GameObject{
    ...
    public Purrito(int x, int y, int velx, int vely, int width, int height, boolean direita) throws ObjetoNaoEncontradoException, IOException {
        ...
        if(ImageIO.read(new File(file.getAbsoluteFile()+"\\src\\main\\java\\tacocat\\Sprites\\purrito.png")) == null){
